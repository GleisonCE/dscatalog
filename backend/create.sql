create table tb_category (id  bigserial not null, created_at TIMESTAMP WITHOUT TIME ZONE, name varchar(50), updated_at TIMESTAMP WITHOUT TIME ZONE, primary key (id));
create table tb_product (id  bigserial not null, date TIMESTAMP WITHOUT TIME ZONE, description TEXT, img_url varchar(255), name varchar(150), price float8, primary key (id));
...
create table tb_user (id  bigserial not null, email varchar(255), first_name varchar(50), last_name varchar(50), password varchar(255), primary key (id));
